...
footer = between(index, r'<footer class="fphoto', r'</footer>') + '\n<div class="endcap"><p class="copy">© 2026 Kaushik Subramaniam</p><svg class="giant" viewBox="0 0 1000 200" preserveAspectRatio="xMidYMin meet" aria-hidden="true"><text x="500" y="230" text-anchor="middle" textLength="1000" lengthAdjust="spacingAndGlyphs">HOLYYKAU</text></svg></div>'
