...
const TICKET_ACTIONS = [
  { id:'tact_p1', name:'P1 critical incident SOP', category:'Escalation', tone:'red', icon:'\u{1F6A8}',
  ...
  { id:'tact_sentiment', name:'Negative sentiment recovery SOP', category:'Relationship', tone:'purple', icon:'\u{1F641}',
  ...
  { id:'tact_revenue', name:'High-revenue account SOP', category:'Commercial', tone:'green', icon:'\u{1F4B0}',
  ...
  { id:'tact_aging', name:'Ageing ticket SOP', category:'Queue hygiene', tone:'blue', icon:'\u{1F4C5}',
  ...
  { id:'tact_close', name:'Resolution and closure SOP', category:'Closure', tone:'teal', icon:'\u2713',
...
function actionsForTicket(ticket){
  if (!ticket) return [];
  return TICKET_ACTIONS.filter(a => { try { return a.appliesWhen(ticket); } catch(e){ return false; } });
}
