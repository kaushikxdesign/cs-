const AUTO_PILLARS = [
  { id:'ticket',   label:'Tickets',   singular:'ticket',   icon: undefined, tone:'red',   desc:'React to changes on support tickets \u2014 priority, status, SLA, escalation.' },
  { id:'customer', label:'Customers', singular:'customer', icon: undefined, tone:'blue',  desc:'React to changes on accounts \u2014 health, adoption, churn, renewal, sentiment.' },
  { id:'contact',  label:'Contacts',  singular:'contact',  icon: undefined, tone:'purple',desc:'React to changes on people \u2014 role, engagement, buying role, departure.' },
];
...
const AUTO_ACTIONS = [
  { group:'Ticket',   items:[
    { id:'t_priority', label:'Set ticket priority',  icon: undefined, arg:'enum', values:AUTO_FIELDS.ticket[1].values },
    { id:'t_status',   label:'Set ticket status',    icon: undefined, arg:'enum', values:AUTO_FIELDS.ticket[2].values },
    { id:'t_assign',   label:'Assign ticket to',     icon: undefined, arg:'enum', values:AUTO_FIELDS.ticket[8].values },
    { id:'t_escalate', label:'Escalate ticket',      icon: undefined,    arg:'none' },
    { id:'t_note',     label:'Add private note',     icon: undefined, arg:'text' },
  ]},
  { group:'Customer', items:[
    { id:'c_health',   label:'Set health band',      icon: undefined,    arg:'enum', values:AUTO_FIELDS.customer[4].values },
    { id:'c_churn',    label:'Set churn status',     icon: undefined, arg:'enum', values:AUTO_FIELDS.customer[6].values },
    { id:'c_goal',     label:'Create goal from template', icon: undefined, arg:'text' },
    { id:'c_risk',     label:'Open risk record',     icon: undefined, arg:'text' },
    { id:'c_qbr',      label:'Schedule QBR',         icon: undefined, arg:'none' },
    { id:'c_owner',    label:'Reassign account CSM', icon: undefined, arg:'enum', values:['Maya Chen','Amara Osei','Sam Rivera'] },
  ]},
  { group:'Contact',  items:[
    { id:'p_engage',   label:'Set engagement level', icon: undefined, arg:'enum', values:AUTO_FIELDS.contact[4].values },
    { id:'p_role',     label:'Set buying role',      icon: undefined, arg:'enum', values:AUTO_FIELDS.contact[5].values },
    { id:'p_flag',     label:'Flag champion departure', icon: undefined, arg:'none' },
    { id:'p_email',    label:'Send email to contact',icon: undefined,    arg:'text' },
  ]},
  { group:'Notify & tasks', items:[
    { id:'n_slack',    label:'Send Slack message',   icon: undefined, arg:'text' },
    { id:'n_teams',    label:'Send MS Teams message',icon: undefined, arg:'text' },
    { id:'n_email',    label:'Send email',           icon: undefined,    arg:'text' },
    { id:'n_manager',  label:'Notify manager',       icon: undefined, arg:'none' },
    { id:'n_task',     label:'Create task',          icon: undefined,    arg:'text' },
    { id:'n_webhook',  label:'Fire webhook',         icon: undefined, arg:'text' },
  ]},
];
...
const ACTION_PILLARS = [
  { id:'customer', label:'Customers', singular:'customer', icon: undefined, tone:'blue',
    desc:'Health, adoption, churn, renewal, sentiment and ARR changes.' },
  { id:'contact',  label:'Contacts',  singular:'contact',  icon: undefined, tone:'purple',
...
const CSM_ACTIONS_EXTRA = [
  { id:'act_jp1', name:'Renewal inside 60 days with no QBR', ownerId:'james', pillar:'customer',
    ...
    steps:[ { key:'n_task_0', id:'n_task', label:'Create task', icon: undefined, arg:'Book the pre-renewal QBR', editable:false, channel:null, subject:'', body:'' },
            { key:'n_slack_1', id:'n_slack', label:'Send Slack message', icon: undefined, arg:'#cs-renewals', editable:true, channel:'Slack message',
  ...
  { id:'act_sk1', name:'Champion engagement drops', ownerId:'sarah', pillar:'contact',
    ...
    steps:[ { key:'p_email_0', id:'p_email', label:'Send email to contact', icon: undefined, arg:'Check-in template', editable:true, channel:'Email to contact',
  ...
  { id:'act_sk2', name:'Strategic account turns amber', ownerId:'sarah', pillar:'customer',
    ...
    steps:[ { key:'n_manager_0', id:'n_manager', label:'Notify manager', icon: undefined, arg:'', editable:false, channel:null, subject:'', body:'' } ] },
];
