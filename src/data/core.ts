...
// ============================================================
const RISK_SIGNALS = {
  usage_decline:  { id:'usage_decline',  label:'Declining usage',        icon:'\u{1F4C9}', tone:'red',
  ...
  support_friction:{ id:'support_friction', label:'Support friction',    icon:'\u{1F3AB}', tone:'amber',
  ...
  account_change: { id:'account_change', label:'Account changes',        icon:'\u2702', tone:'purple',
  ...
  feedback_scores:{ id:'feedback_scores', label:'Feedback scores',       icon:'\u2B50', tone:'amber',
  ...
  no_engagement:  { id:'no_engagement',  label:'No engagement',          icon:'\u{1F515}', tone:'slate',
  ...
  unresponsive:   { id:'unresponsive',   label:'Non-responsive',         icon:'\u2709', tone:'red',
  ...
  acquisition:    { id:'acquisition',    label:'Company acquisition',    icon:'\u{1F91D}', tone:'blue',
  ...
  sentiment_drop: { id:'sentiment_drop', label:'Sentiment trending negative', icon:'\u{1F641}', tone:'red',
...
const EXPANSION_SIGNALS = {
  seat_saturation: { id:'seat_saturation', label:'Seat saturation', icon:'\u{1F465}', tone:'blue',
  ...
  feature_bumping: { id:'feature_bumping', label:'Feature bumping', icon:'\u{1F512}', tone:'purple',
  ...
  volume_threshold: { id:'volume_threshold', label:'Volume thresholds', icon:'\u{1F4C8}', tone:'amber',
  ...
  team_velocity: { id:'team_velocity', label:'Team velocity', icon:'\u26A1', tone:'green',
  ...
  workflow_spread: { id:'workflow_spread', label:'Workflow spread', icon:'\u{1F500}', tone:'teal',
